...
export default async function (execute_file_count, execute_file_dir, execute_file_length, mode) {
    ...
    const json_config = readjson(process.cwd() + "/Tre.Extension/Tre.Settings/toolkit.json", true);
    ...
    if (js_checker.is_array(execute_file_dir)) {
        execute_file_dir.forEach((child_file_bundle, index) => {
    ...
    ;
    const checkfile = (js_checker.is_array(execute_file_dir)) ? false : check_is_file(execute_file_dir);
    ...
    if (tre_selector.length === 0) {
        ...
        const option = Console.ExpandReadLine(tre_selector);
        async function execute_function_from_core(execute_file_dir) {
            let width;
            let height;
            let encryption_key;
            const check_if_the_directories_iz_folder = (!js_checker.is_array(execute_file_dir) && check_is_file(execute_file_dir)) ? false : true;
            switch (option) {
                ...
                case Display.Tre.Function.tre_void_javascript_void_execute.void_number_readline_argument():
                    try {
                        if (!js_checker.is_array(execute_file_dir)) {
                            const js_shell_string_await_for_executor = (readfile(execute_file_dir));
                            let javascript_shell_allow_this_funcction = ban(["eval",
                ...
                case Display.Tre.Function.popcap_resources_cat.void_number_readline_argument():
                    ...
                    let mode = Console.IntegerReadLine(1, 2);
                    ...
                    let encode = Console.IntegerReadLine(0, 1);
                    if (!js_checker.is_array(execute_file_dir)) {
                ...
                case Display.Tre.Function.popcap_texture_atlas_cat_simple.void_number_readline_argument():
                    ...
                    if (!js_checker.is_array(execute_file_dir)) {
                        await atlas_cat(execute_file_dir, (width), (height), true, Argument.Tre.Packages.popcap_texture_atlas_cat_max_rects_bin_display_not_atlas_info, Argument.Tre.Packages.popcap_texture_atlas_cat_max_rects_bin_display_cannot_find_groups_array_in_atlasinfo, Argument.Tre.Packages.popcap_texture_atlas_cat_max_rects_bin_display_cannot_find_subgroup_in_atlas_info, Argument.Tre.Packages.popcap_texture_atlas_cat_max_rects_bin_display_cannot_find_method_in_atlas_info, Argument.Tre.Packages.popcap_texture_atlas_cat_max_rects_bin_display_cannot_get_res_data_from_this_atlas_info, Argument.Tre.Packages.popcap_texture_atlas_cat_max_rects_bin_display_not_found_res_indicated_in_subgroups, Argument.Tre.Packages.popcap_texture_atlas_cat_max_rects_bin_display_total_sprites_sheet_process_in_this_void).finally(() => { });
                    }
                    break;
                case Display.Tre.Function.popcap_atlas_pack_experimental.void_number_readline_argument():
                    ...
                    let popcap_subgroup_name = Console.ReadLine();
                    ...
                    let popcap_support_utilities_for_new_pvz2_international = Console.IntegerReadLine(1, 2);
                    ...
                    let popcap_support_trimming_mode_for_pvz2_texfmt_0 = Console.IntegerReadLine(0, 1);
                ...
                case Display.Tre.Function.popcap_resources_local_data_compare.void_number_readline_argument():
                    if (!js_checker.is_array(execute_file_dir)) {
                        ...
                        let local_new_res_to_compare = Console.ReadPath();
                ...
                case Display.Tre.Function.popcap_texture_atlas_cat.void_number_readline_argument():
                    ...
                    let atlas_cat_smart_option_area = Console.IntegerReadLine(0, 1);
                    ...
                    Console.WriteLine(`${Argument.Tre.Packages.default_boolean_with_false}`);
                    Console.WriteLine(`${Argument.Tre.Packages.default_boolean_with_true}`);
                    let atlas_cat_pot_option_area = Console.IntegerReadLine(0, 1);
                    ...
                    Console.WriteLine(`${Argument.Tre.Packages.default_boolean_with_false}`);
                    Console.WriteLine(`${Argument.Tre.Packages.default_boolean_with_true}`);
                    let atlas_cat_square_option_area_force = Console.IntegerReadLine(0, 1);
                    ...
                    Console.WriteLine(`${Argument.Tre.Packages.default_boolean_with_false}`);
                    Console.WriteLine(`${Argument.Tre.Packages.default_boolean_with_true}`);
                    let atlas_cat_allow_rotation_option_area_force = Console.IntegerReadLine(0, 1);
                    ...
                    let atlas_cat_padding_size = Console.IntegerReadLine(0, width);
                    if (!js_checker.is_array(execute_file_dir)) {
                ...
                case Display.Tre.Function.popcap_game_json_split.void_number_readline_argument():
                    Console.WriteLine(color.fgcyan_string(`${Argument.Tre.Packages.popcap_game_rewrite_mode}`));
                    const popcap_json_split_mode_selector = Console.IntegerReadLine(1, 2);
                    if (!js_checker.is_array(execute_file_dir)) {
                ...
                case Display.Tre.Function.popcap_old_resources_conversion_to_new_resources.void_number_readline_argument():
                    if (!js_checker.is_array(execute_file_dir)) {
                        let old_to_new_conversion = new AdaptPvZ2InternationalResPath.res_conversion();
                ...
                case Display.Tre.Function.popcap_resources_to_atlasinfo.void_number_readline_argument():
                    ...
                    let method_for_res_to_atlas_info = Console.IntegerReadLine(1, 2);
                ...
                case Display.Tre.Function.popcap_texture_atlas_split.void_number_readline_argument():
                    ...
                    let atlas_split_method = Console.IntegerReadLine(1, 2);
                    if (js_checker.is_array(execute_file_dir)) {
                ...
                case Display.Tre.Function.tre_void_json_patch_work.void_number_readline_argument():
                    if (!js_checker.is_array(execute_file_dir)) {
                        ...
                        let json_apply_path = readline_for_json(execute_file_dir);
                        let apply_patch = readjson(execute_file_dir);
                ...
                case Display.Tre.Function.tre_void_json_patch_generator.void_number_readline_argument():
                    if (!js_checker.is_array(execute_file_dir)) {
                        ...
                        let json_new_file_compare_diff = readline_for_json(execute_file_dir);
                ...
                case Display.Tre.Function.popcap_lawnstrings_diff.void_number_readline_argument():
                    if (!js_checker.is_array(execute_file_dir)) {
                        ...
                        let new_compare_json_diff = readline_for_json(execute_file_dir);
                ...
                case Display.Tre.Function.tre_void_real_esrgan_upscaler_bitmap_content.void_number_readline_argument():
                    if (!js_checker.is_array(execute_file_dir) && !check_if_the_directories_iz_folder) {
                        ...
                        let upscale_model = Console.IntegerReadLine(1, 2);
                        ...
                        const new_folder_contain_upscale_images = `${execute_file_dir}_x${upscale_data}`;
...
export { writefile, writejson, basename, delete_file, read_single_folder, read_dir, readfilebuffer, js_checker, file_stats, fs_js, stringify, parse, };
