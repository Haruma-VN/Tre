...
export namespace Display.Tre.Function {
    ...
    export const tre_void_third_party_bzip2_compress = new Void("BZip2 Compress", 18);
    export const tre_void_third_party_bzip2_decompress = new Void("BZip2 Decompress", 19);
    export const tre_void_third_party_brotli_compress = new Void("Brotli Compress", 20);
    export const tre_void_third_party_brotli_decompress = new Void("Brotli Decompress", 21);
    // continue
    export const tre_void_javascript_void_execute = new Void("JavaScript Void Execute", 22);
    export const popcap_resources_split = new Void("PopCap Resources Split", 23);
    export const popcap_resources_cat = new Void("PopCap Resources Concat", 24);
    // todo
    export const popcap_resources_rewrite = new Void("PopCap Resources Rewrite", 25);
