...
export default async function (dir = process.argv[2], width = 4096, height = 4096) {
    ...
    let image_dir = path.dirname(dir) + '/';
    let image_name = path.basename(dir).toUpperCase();
    var pvr_header = Buffer.from('505652030000000006000000000000000000000000000000BBBBBBBBAAAAAAAA0100000001000000010000000100000000000000', 'hex');
