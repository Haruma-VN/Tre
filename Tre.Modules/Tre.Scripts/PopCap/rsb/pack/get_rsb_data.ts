...
export default async function (RSB_composite_files: string[], TreRSBInfo: any[], rsb_path: string, pool_index: number, composite_pool_index: number):Promise<ArrayBuffer> | Promise<void> {
