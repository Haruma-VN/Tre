...
export default async function (file_input, arg) {
    const buffer = readfilebuffer(file_input);
    ...
    let rsgp_data = "";
    function Unpack_Rsgp(offset, size, image, compression) {
        exception_json.CompressionMethod = compression;
        async function Decompression_Data(temp_offset, name_path) {
