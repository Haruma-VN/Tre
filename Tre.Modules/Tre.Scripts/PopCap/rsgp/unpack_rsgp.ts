...
export default async function (rsgp_data: any, rsgp_path: string, decode_image:boolean = false, decode_rton:boolean = false, remove_info:boolean = false, ios_argb8888: number) {
    ...
    async function WriteFile(name_path: string, temp_offset: any, atlas:boolean, ...any_any: number[]) {
    ...
    async function Unpack_Rsgp(offset:number, size:number, atlas:bool, compression:bool) {
