...
build.then(() => {
    console.log(`\x1b[32m◉ NodeJS Application: ${create_data_view_config.properties.ProductName}\x1b[0m`);
    console.log(`\x1b[32m◉ Version: ${create_data_view_config.version}\x1b[0m`);
    console.log(`\x1b[32m◉ Entry: ${path.resolve(create_data_view_config.entry)}\x1b[0m`);
    console.log(`\x1b[32m◉ Build: ${path.resolve(create_data_view_config.out)}\x1b[0m`);
