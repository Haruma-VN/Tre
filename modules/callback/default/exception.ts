...
namespace System.Tre.Checker {
    ...
    export function check_tre_extension(): boolean {
        const extension_folder: string = path.dirname(process.argv[1]) + "/extension";
    ...
    export function check_tre_toolkit_json(): boolean {
        const toolkit_json_file_path: string = path.dirname(process.argv[1]) + "/extension/settings/toolkit.json";
    ...
    export function check_tre_third_party(): boolean {
        const tre_third_party_for_raw_images: string = path.dirname(process.argv[1]) + "/extension/third/encode/";
        ...
        const tre_third_party_for_etc_pak: string = path.dirname(process.argv[1]) + "/extension/third/encode/etcpak.exe";
        ...
        const tre_third_party_for_pvrtc: string = path.dirname(process.argv[1]) + "/extension/third/encode/PVRTexToolCLI.exe";
        ...
        const tre_third_party_for_upscaler: string = path.dirname(process.argv[1]) + "/extension/third/real_esrgan/";
        ...
        const tre_third_party_for_upscaler_real_esrgan: string = path.dirname(process.argv[1]) + "/extension/third/real_esrgan/realesrgan-ncnn-vulkan.exe";
    ...
    export function check_node_modules(): boolean {
        const node_modules_folder: string = path.dirname(process.argv[1]) + "/node_modules";
