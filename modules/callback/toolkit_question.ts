...
export namespace Argument.Tre.Packages {
    ...
    export const json_patch_generator_new_execution_generator = `◉ ${localization("execution_argument")}: ${localization("new_json")}`;
    export const json_patch_finish_write_patch = `◉ ${localization("execution_finish")}: ${localization("generated_patch")}`;
    export const upscaler_real_esrgan_upscale_model = `◉ ${localization("execution_argument")}: ${localization("upscale_model")}`;
    export const upscaler_real_esrgan_upscale_ratio = `◉ ${localization("execution_argument")}: ${localization("upscale_ratio")}`;
