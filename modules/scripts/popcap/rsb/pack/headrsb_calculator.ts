...
export default function (rsgpfile_info_number: number, file_list_length: number, rsgp_list_length: number, composite_list_length: number, composite_info_length: number, composite_number: number, ptx_length: number) {
    ...
    let head_length = 112 + file_list_length + rsgp_list_length + composite_list_length + composite_info_length + ptx_length + rsgp_data_info_length + autopool_info_length;
    ...
    rsb_head_info.writeInt32LE(112 + file_list_length + rsgp_list_length + composite_info_length + composite_list_length);
    ...
    rsb_head_info.writeInt32LE(112 + file_list_length + rsgp_list_length + composite_info_length);
    rsb_head_info.writeInt32LE(rsgpfile_info_number);
    rsb_head_info.writeInt32LE(112 + file_list_length + rsgp_list_length + composite_info_length + composite_list_length + rsgp_data_info_length);
    rsb_head_info.writeInt32LE(152);
    rsb_head_info.writeInt32LE(ptx_length / 16);
    rsb_head_info.writeInt32LE(112 + file_list_length + rsgp_list_length + composite_info_length + composite_list_length + rsgp_data_info_length + autopool_info_length);
