...
export default async function (rsgp_data: any, rsgp_path: string, decode_image:boolean = false, decode_rton:boolean = false, 
    remove_info:boolean = false, ios_argb8888: number, no_notify_message:boolean = false) {
