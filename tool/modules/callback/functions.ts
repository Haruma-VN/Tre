...
export default async function (
    ...
    const generate_modules =
        Display.Tre.Function.create_new_functions_view.sort((a, b) => {
            return (
    ...
    generate_modules.forEach((module_on_waiting_list) => {
        if (
            ...
            Display.Tre.Function.DisplayItems(
                tre_selector,
                module_on_waiting_list
            );
        } else if (
    ...
    if (tre_selector.length === 0) {
        ...
        if (typeof execute_file_dir === "string") {
            ...
            option !==
                Display.Tre.Function.popcap_texture_atlas_split.void_number_readline_argument() &&
            option !==
                Display.Tre.Function.popcap_atlas_split_advanced.void_number_readline_argument()
        ) {
