...
export namespace Display.Tre.Function {
    ...
    const execution_evaluate_view = (
        ...
        )[evaluate_function_name] as render_toolkit_expression;
    };
    ...
    export const popcap_old_resources_conversion_to_new_resources: Void =
        new Void(
    ...
    export const popcap_new_resources_conversion_to_old_resources: Void =
        new Void(
    ...
    export function DisplayItems(
        ...
        toolkit_selector_array_list.push(
            display_item_list.void_number_readline_argument()
        );
        return;
    }
    ...
    export function BaseNameChecker(
        ...
        find_case_in_lower_case: string | number
    ): boolean {
        find_case_in_lower_case =
            typeof find_case_in_lower_case === "number"
