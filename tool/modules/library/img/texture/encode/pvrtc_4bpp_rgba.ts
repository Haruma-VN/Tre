...
export default function encode_pvrtc_4bpp_rgba(img_buf: Buffer): Buffer {
    ...
    function encode_image(width: number, height: number, img_c: any): Buffer {
        ...
        const pvrtc_word_image: Array<any> = PVRTC_coder.PVRTC.encode_rgba_4bpp(pixels, new_width);
