...
function conduct_atlas_info(
    ...
    if (file_system_output_as_string === undefined || file_system_output_as_string === null || file_system_output_as_string === void 0) {
    ...
    if (subgroup_name === undefined || subgroup_name === null || subgroup_name === void 0) {
        ...
        while (true) {
            if ((subgroup_name.indexOf("_1536") != -1) || (subgroup_name.indexOf("_768") != -1) || (subgroup_name.indexOf("_384") != -1) ||
                (subgroup_name.indexOf("_1200") != -1) || (subgroup_name.indexOf("_640") != -1)) {
                break;
            }
    ...
    if (!is_return_mode) {
        ...
        return fs_js.write_json(file_system_output_as_string, create_atlas_info);
    }
