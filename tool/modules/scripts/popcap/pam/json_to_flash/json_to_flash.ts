...
export default function (animation_json: any, animation_path: string, texture_reslution: number) {
    const pamxfl_folder = `${parse(animation_path).dir}/${parse(animation_path).name}.xfl`;
