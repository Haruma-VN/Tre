            ...
            if (layer.state) {
                let frame_array = !layer.sprite
                          ...
                          elements: {
                              DOMSymbolInstance: {
                                  ...
                                  color: {
                                      Color: {
                                          redMultiplier:
                                              layer.color[0].toFixed(6),
                                          greenMultiplier:
                                              layer.color[1].toFixed(6),
                                          blueMultiplier:
                                              layer.color[2].toFixed(6),
                                          alphaMultiplier:
                                              layer.color[3].toFixed(6),
                                      },
                                  },
                              },
                          },
                    ...
                    : {
                          ...
                          elements: {
                              DOMSymbolInstance: {
                                  libraryItemName: `sprite/sprite_${
                                      layer.resource + 1
                                  }`,
                                  symbolType: "graphic",
                                  loop: "loop",
