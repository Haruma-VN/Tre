...
export default function (
    ...
    const rsg_data_info_length = rsgfile_info_number * 204;
    const autopool_info_length = rsgfile_info_number * 152;
    let head_length =
        112 +
        file_list_length +
        rsg_list_length +
    ...
    rsb_head_info.writeInt32LE(0);
    rsb_head_info.writeInt32LE(0);
    rsb_head_info.writeInt32LE(rsg_list_length);
    rsb_head_info.writeInt32LE(112 + file_list_length);
    rsb_head_info.writeInt32LE(rsgfile_info_number);
    ...
    rsb_head_info.writeInt32LE(112 + file_list_length + rsg_list_length);
    rsb_head_info.writeInt32LE(1156);
    rsb_head_info.writeInt32LE(composite_list_length);
    rsb_head_info.writeInt32LE(
        112 + file_list_length + rsg_list_length + composite_info_length
    );
    rsb_head_info.writeInt32LE(rsgfile_info_number);
    rsb_head_info.writeInt32LE(
        112 +
